document.addEventListener('DOMContentLoaded',function (){
    ...
    const pb_dynamic_form_field = document.getElementById('pb_dynamic_form_field')
    ...
    pb_badge_type.addEventListener('change', ()=>{
        ...
        if (value === 'dynamic') {
            pb_dynamic_form_field.classList.remove('hidden');
            pb_custom_badge_form_field.classList.add('hidden');
        } else if (value === 'custom') {
            pb_dynamic_form_field.classList.add('hidden');
